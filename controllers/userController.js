...
exports.handleLogin = async (req, res, next) => {
    ...
    const secretKey = "6Lf8R70aAAAAAPj2x8DJCHeyDg9RsoZNHPAqZZIp";
...
exports.handleForgetPassword = async (req, res) => {
    ...
    const token = jwt.sign({ userId: user._id }, "hV37j4WfWxqz9r2", {
      expiresIn: "1h",
    });
...
exports.resetPassword = async (req, res) => {
    ...
    try {
        decodedToken = jwt.verify(token, "hV37j4WfWxqz9r2");
    } catch (err) {
        console.log(err);
        if (!decodedToken) {
